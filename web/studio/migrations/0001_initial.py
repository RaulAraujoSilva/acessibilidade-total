    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.FileField(upload_to=studio.models.upload_path)),
                ('original_name', models.CharField(max_length=255)),
                ('content', models.JSONField(default=dict)),
                ('options', models.JSONField(default=dict)),
                ('status', models.CharField(choices=[('created', 'Criado'), ('queued', 'Aguardando'), ('running', 'Processando'), ('review', 'Aguardando revisão'), ('done', 'Concluído'), ('failed', 'Falhou'), ('cancelled', 'Cancelado')], default='created', max_length=12)),
                ('stage', models.CharField(default='Recebido', max_length=80)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studio.document')),
            ],
            options={
